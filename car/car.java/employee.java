...
public class employee {
	...
	public static void main(String[] args) {
		...
		empy.setEmployee_Id(2); // set the id value to 2
		empy.setEmplpoyee_Name("Philip");// set the Name value to Philip
		empy.setEmplpoyee_Salary(200);// set the Salary value to 200
